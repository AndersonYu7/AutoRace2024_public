...
class ParameterAdjuster(Node):
    def __init__(self):
        ...
        self.publisher_top_x = self.create_publisher(Float64, 'top_x_topic', QoSProfile(depth=10))
        self.publisher_top_y = self.create_publisher(Float64, 'top_y_topic', QoSProfile(depth=10))
        self.publisher_bottom_x = self.create_publisher(Float64, 'bottom_x_topic', QoSProfile(depth=10))
        self.publisher_bottom_y = self.create_publisher(Float64, 'bottom_y_topic', QoSProfile(depth=10))
        self.publisher_hue_white_l = self.create_publisher(Float64, 'hue_white_l_topic', QoSProfile(depth=10))
        self.publisher_hue_white_h = self.create_publisher(Float64, 'hue_white_h_topic', QoSProfile(depth=10))
        self.publisher_saturation_white_l = self.create_publisher(Float64, 'saturation_white_l_topic', QoSProfile(depth=10))
        self.publisher_saturation_white_h = self.create_publisher(Float64, 'saturation_white_h_topic', QoSProfile(depth=10))
        self.publisher_lightness_white_l = self.create_publisher(Float64, 'lightness_white_l_topic', QoSProfile(depth=10))
        self.publisher_lightness_white_h = self.create_publisher(Float64, 'lightness_white_h_topic', QoSProfile(depth=10))
        self.publisher_reliability_white_line = self.create_publisher(Float64, 'reliability_white_line_topic', QoSProfile(depth=10))
        self.publisher_hue_yellow_l = self.create_publisher(Float64, 'hue_yellow_l_topic', QoSProfile(depth=10))
        self.publisher_hue_yellow_h = self.create_publisher(Float64, 'hue_yellow_h_topic', QoSProfile(depth=10))
        self.publisher_saturation_yellow_l = self.create_publisher(Float64, 'saturation_yellow_l_topic', QoSProfile(depth=10))
        self.publisher_saturation_yellow_h = self.create_publisher(Float64, 'saturation_yellow_h_topic', QoSProfile(depth=10))
        self.publisher_lightness_yellow_l = self.create_publisher(Float64, 'lightness_yellow_l_topic', QoSProfile(depth=10))
        self.publisher_lightness_yellow_h = self.create_publisher(Float64, 'lightness_yellow_h_topic', QoSProfile(depth=10))
        self.publisher_reliability_yellow_line = self.create_publisher(Float64, 'reliability_yellow_line_topic', QoSProfile(depth=10))
